	            	...
	            	<div class="slider_cnt">
	            		<div class="absolute">
	            			<div class="wrapper">
	            				...
	            				<a style="margin-top: 20px;" class="pagescroll" href="#expertise">Mehr</a>
	            			</div><!--wrapper-->
	            		</div><!--absolute-->
...
Kunden? Diese Frage steht im Zentrum jedes unternehmerischen Handelns. Als Business Consultant stellen wir die Analyse der Geschäftstätigkeit in den Mittelpunkt.</p>
	            				<a href="#services" class="pagescroll" id="b_1">Mehr</a>
	            			</div><!--wrapper-->
	            		</div><!--absolute-->
...
Realisierung Ihrer Projekte. Unsere erfahrenen Projekt Manager übernehmen die professionelle Beratung, Planung, Leitung, Kontrolle und Dokumentation Ihres Projekts.</p>
	            				<a href="#services" class="pagescroll" id="b_2">Mehr</a>
	            			</div><!--wrapper-->
	            		</div><!--absolute-->
...
den grundlegenden Vorgehensansätze der klassischen und agilen Welt und stellen die das Dokumentieren, Verwalten und Prüfen von Anforderungen sicher.</p>
	            				<a href="#services" class="pagescroll" id="b_3">Mehr</a>
	            			</div><!--wrapper-->
	            		</div><!--absolute-->
	            	...
	            	<div class="slider_cnt">
	            		<div class="absolute">
	            			<div class="wrapper">
	            				...
	            				<a href="#services" class="pagescroll" id="b_4">Mehr</a>
	            			</div><!--wrapper-->
	            		</div><!--absolute-->
	            	...
	            	<div class="slider_cnt">
	            		<div class="absolute">
	            			<div class="wrapper">
	            				...
	            				<a href="#services" class="pagescroll" id="b_5">Mehr</a>
	            			</div><!--wrapper-->
	            		</div><!--absolute-->
...
Schulungsunterlagen und führen Schulungen auch selber durch. Wir bieten im Projekt-Umfeld sowohl Trainings für Ihr Projektteam im Rahmen der Projektvorbereitung sowie Anwenderschulungen an.</p>
	            				<a href="#services" class="pagescroll" id="b_6">Mehr</a>
	            			</div><!--wrapper-->
	            		</div><!--absolute-->
			...
			<div class="full_width expertise_cnt">
				<div class="wrapper">
					...
					<ul class="colm-3">
						...
						<li class="colm-3-li">
							<div class="image Element_Animation_2"><img src="img/data.png" alt="Banking"></div>
